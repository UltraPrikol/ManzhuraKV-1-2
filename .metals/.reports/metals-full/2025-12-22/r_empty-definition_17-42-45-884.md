error id: file:///E:/labs/lab-6-4/src/SparkExample.scala:`<none>`.
file:///E:/labs/lab-6-4/src/SparkExample.scala
empty definition using pc, found symbol in pc: `<none>`.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/spark/sql/functions/println.
	 -org/apache/spark/sql/functions/println#
	 -org/apache/spark/sql/functions/println().
	 -spark/implicits/println.
	 -spark/implicits/println#
	 -spark/implicits/println().
	 -println.
	 -println#
	 ...
	 -scala/Predef.println().
offset: 498
uri: file:///E:/labs/lab-6-4/src/SparkExample.scala
text:
```scala
...
object SparkExample {
  ...
  def demonstrateSparkOperations(spark: SparkSession): Unit = {
    ...
    pr@@intln("=== Apache Spark Operations ===")
