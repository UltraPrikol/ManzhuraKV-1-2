error id: file:///E:/labs/lab-6-4/src/main.scala:stop.
file:///E:/labs/lab-6-4/src/main.scala
empty definition using pc, found symbol in pc: stop.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -org/apache/spark/sql/functions/spark/stop.
	 -org/apache/spark/sql/functions/spark/stop#
	 -org/apache/spark/sql/functions/spark/stop().
	 -spark/implicits/spark/stop.
	 -spark/implicits/spark/stop#
	 -spark/implicits/spark/stop().
	 -spark/stop.
	 -spark/stop#
	 -spark/stop().
	 -scala/Predef.spark.stop.
	 -scala/Predef.spark.stop#
	 -scala/Predef.spark.stop().
offset: 1891
uri: file:///E:/labs/lab-6-4/src/main.scala
text:
```scala
