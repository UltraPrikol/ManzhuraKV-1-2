# Отчет по лабораторной работе 0501
...
## Цель работы
Освоить практическое применение паттернов проектирования для рефакторинга и улучшения кодовой базы системы учета сотрудников.
Получить навыки применения различных паттернов для решения типичных задач проектирования ПО.
...
--- 2. Abstract Factory ---
Created via Abstract Factory: [TECH_DEPT] Tech Lead ($7000)

--- 3. Builder ---
Built Developer: [DEV] John Doe ($5000), Skills: ['Python', 'Java']

--- 4. Observer ---

--- 5. Strategy ---
Base Salary: 5000
With Performance Bonus: 6000.0
With Seniority Bonus: 6000.0

--- 6. Command ---
COMMAND: Hired John Doe
!!! NOTIFICATION: Salary changed for John Doe: 5000 -> 8000 !!!
Undoing salary update...
!!! NOTIFICATION: Salary changed for John Doe: 8000 -> 5000 !!!

--- 7. Decorator ---
Decorated Salary: 6500.0
Decorated Skills: ['Python', 'Java', 'Docker']

--- 8. Facade & Adapter ---
Net Salary (via Facade->Adapter): 5220.0

--- 9. Unit of Work ---

--- UoW Committing Transaction ---
UoW: Inserted Alice Junior

--- 10. Specification ---
Found employees (Salary > 4000 & Dept == DEV):
 - John Doe ($6000.0)
